...
void _addExcersize(String name, String description, String sets) {
    var excersize = ExcersizeContent(name: name, description: description, sets: sets, initNum: 4);
...
void _removeExcersize(ExcersizeContent excersize) {
  ...
  Widget build(BuildContext context) {
    List<ExcersizeContent> day4Excersizes = widget.workouts.excersizesContent.where((ex) => ex.initNum == 4).toList();
                 ...
                 child: Container(
                  ...
                  child: const Center(
                    child: Icon(Icons.add),
                      ...
                      Expanded(child: GridView.builder(itemCount: day4Excersizes.length,
                      gridDelegate:  SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2, childAspectRatio: 1),
                                    itemBuilder: (context, index) {
                      ExcersizeContent individualExcersize = day4Excersizes[index];
